...
module.exports = async (
  ...
  try {
    ...
    <div style="padding:20px">
      ...
      <p>
        We are delighted to offer you the position of ${hiring_title} at ${company_name}. Your qualifications and experience have impressed us, and we believe you would be a valuable addition to our team.
      </p>
      <p>
        Position: ${hiring_title}
      </p>
    <p>
        Description: ${hiring_message}
      </p>
      <p>
